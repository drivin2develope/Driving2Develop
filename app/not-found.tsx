  ...
  return (
    <div className="min-h-screen bg-[var(--color-base)] flex flex-col items-center justify-center px-5 text-center relative">
      ...
      <div className="relative">
        ...
        <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-[rgba(227,179,65,0.12)] text-[var(--color-gold)]"><Compass size={26} /></div>
        ...
        <div className="mt-7 flex items-center justify-center gap-3">
          ...
          <Link href="/dashboard" className="rounded-lg border border-[var(--color-border-strong)] px-5 py-2.5 text-sm hover:bg-white/5 transition">Go to dashboard</Link>
        </div>
      </div>
    </div>
  );
