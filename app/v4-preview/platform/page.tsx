        ...
        <section className="relative overflow-hidden" style={{ background: "var(--v4-bg)" }}>
          ...
          <div className="relative max-w-[1600px] mx-auto px-6 md:px-10 pt-20 pb-16 md:pt-28">
            ...
            <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl">
              <V4StatCard label={STATUS_LABEL.available} value={counts.available} />
              <V4StatCard label={STATUS_LABEL.beta} value={counts.beta} />
              <V4StatCard label={STATUS_LABEL.planned} value={counts.planned} />
              <V4StatCard label={STATUS_LABEL.research} value={counts.research} />
            </div>
                ...
                {cat.items.map((item) => {
                  ...
                  return (
                    <Wrapper
                      ...
                      className="v4-diagram-node p-5 flex flex-col justify-between transition-colors"
