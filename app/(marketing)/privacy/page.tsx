...
export default function PrivacyPage() {
  return (
    <LegalPage
      ...
      updated="July 2026"
      sections={[
        { heading: "Overview", body: ["This policy explains what Driving2Develop collects, why, and the choices you have. This is a demonstration product; adapt this policy to your jurisdiction and counsel before production use."] },
