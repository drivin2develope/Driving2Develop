...
export default function ContactPage() {
  return (
    <Section className="pt-16 md:pt-20 pb-20 grid md:grid-cols-2 gap-10 items-start">
      <FadeIn>
        <span className="text-2xs font-semibold uppercase tracking-widest text-[var(--color-gold-text)]">Contact</span>
        ...
        <div className="mt-8 space-y-4">
          {[
            { icon: Mail, title: "Email", body: "partners@driven2develop.dev" },
            ...
            <div key={c.title} className="flex items-start gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[rgba(227,179,65,0.1)] text-[var(--color-gold-text)]"><c.icon size={17} /></div>
              <div>
