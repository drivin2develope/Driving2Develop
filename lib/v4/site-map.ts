  ...
  categories: [
    ...
    },
    {
      ...
      items: [
        ...
        { slug: "assignments-playbooks", label: "Assignments & Playbooks", status: "available", blurb: "Targeted drills assigned from evidence, not guesswork.", href: "/v4-preview/platform/assignments-playbooks" },
        { slug: "compliance", label: "Compliance Monitoring", status: "available", blurb: "Score-threshold flags on real risk patterns — coaching signals, not accusations.", href: "/v4-preview/platform/compliance" },
        { slug: "manager-copilot", label: "Manager Copilot", status: "available", blurb: "Rule-based answers about your team, from real session data.", href: "/v4-preview/platform/manager-copilot" },
        { slug: "leaderboard", label: "Leaderboard & Gamification", status: "available", blurb: "Most improved, highest score, and streaks from real session data.", href: "/v4-preview/platform/leaderboard" },
