...
export function V4PlatformSection() {
      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-10">
        <div className="grid lg:grid-cols-[440px_1fr] gap-16 items-start">
          <div className="lg:sticky lg:top-28">
            ...
            <a
              href="#"
              className="mt-8 inline-flex items-center gap-1.5 text-sm font-semibold group"
                      ...
                      <div className="flex-1">
                        <p
                          ...
                          style={
                            line.tag
                              ? {
                                  background: isActive
                                    ? "color-mix(in srgb, var(--v4-gold-b) 22%, transparent)"
                                    : "color-mix(in srgb, var(--v4-red) 16%, transparent)",
                        ...
                        {line.tag && (
                          <span
                            ...
                            style={{ color: isActive ? "var(--v4-gold-b)" : "var(--v4-red)" }}
                          >
