...
const COLORS: Record<BadgeColor, string> = {
  default: "bg-[var(--color-border)] text-[var(--color-secondary)] ring-1 ring-inset ring-[var(--color-border-strong)]",
  ...
  gold: "bg-[rgba(227,179,65,0.12)] text-[var(--color-gold-text)] ring-1 ring-inset ring-[rgba(227,179,65,0.24)]",
};
