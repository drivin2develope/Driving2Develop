...
/**
 * FROZEN HISTORICAL SNAPSHOT - Navigation V2
 * Exact recovery from commit 3537a8c (components/v4/V4Nav.tsx) - the
 * mega menu rebuilt to read from lib/v4/site-map.ts (real status badges
 * per item), before the hover/motion polish pass (65324c4) and the
 * keyboard-focus-management fix (26c6371).
 */
...
export function NavV2({ theme, onToggleTheme }: { theme: "dark" | "light"; onToggleTheme: () => void }) {
