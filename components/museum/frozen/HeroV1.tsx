...
/**
 * FROZEN HISTORICAL SNAPSHOT - Homepage Hero V1
 * Exact recovery from commit 55718d6 (components/v4/V4Hero.tsx), the state
 * immediately before the trust/irritation arc gauge was added in 65324c4.
 * Do not edit to "improve" - this exists to be historically faithful.
 * Isolated under components/museum/frozen/ so it never collides with the
 * live V4Hero.tsx as that component continues to evolve.
 */
import { motion } from "framer-motion";
import { ArrowUpRight, Circle } from "lucide-react";
import { CountUpMetric, LiveWaveform } from "@/components/v4/ui/V4Metrics";
